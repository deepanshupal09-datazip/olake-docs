...
### 5. Interacting with Olake
      ...
      2. Create and Configure a Job: Create a Job to define and run the data pipeline:
        ...
        #### Set up the Source:
              ...
              * **Password**: password 
              ...
              ![OLake's job creation screen for setting up a new MySQL source, including connection details and sample source.json configuration](/img/docs/playground/olake-iceberg-presto-1.webp)
        ...
        #### Set up the Destination:
             ...
             * **S3 Secret Key**: minio123 
             ...
             ![OLake Apache Iceberg destination setup with REST catalog and S3 settings](/img/docs/playground/olake-iceberg-presto-2.webp)
  ...
  ### 6. Query in Presto 
     ...
     ```
     ![Presto cluster overview with no queries running and one active worker](/img/docs/playground/prestoweb.webp)
    ...
    SELECT * FROM iceberg.weather.weather LIMIT 10; 
     ![Weather data SQL query results showing date, station, and temperature columns](/img/docs/playground/presto_query.webp)
