...
![Data lake evolution diagram from immutable files to ACID lakehouse tables](/img/blog/2025/11/evolution.webp)
...
![Apache Iceberg metadata architecture layers showing snapshots and manifest files](/img/blog/2025/11/architecture.webp)
...
![Deletion vectors workflow diagram comparing position delete and equality delete approaches](/img/blog/2025/11/deletionvectors.webp)
...
![Iceberg table row state visualization showing active and deleted rows per data file](/img/blog/2025/11/active-deleted-rows.webp)
...
![Delta Lake transaction log architecture with Parquet data files and JSON log](/img/blog/2025/11/delta-lake-transaction.webp)
...
![Side by side comparison of Copy-on-Write vs Merge-on-Read deletion strategies](/img/blog/2025/11/comparsion-formats.webp)
...
![Read and write performance trade-offs between CoW and MoR deletion strategies](/img/blog/2025/11/cow-mor.webp)
