---
title: Benchmarks
description: Unified OLake Benchmarks across Postgres, MongoDB, and MySQL
sidebar_position: 2
slug: /benchmarks
---
...
|----------------------------------------------------|-------------|-------------------------|--------------------|
| **OLake** <br/><span className='text-xs text-slate-500'>(as of 14th Sept 2025)</span>         | **4.01 B**  | **2,35,411 RPS**        | –                  |
| Fivetran <br/><span className='text-xs text-slate-500'>(as of 30th Apr 2025)</span>           | 4.01 B      | 46,395 RPS              | **5.1 × slower**   |
| Debezium (memiiso) <br/><span className='text-xs text-slate-500'>(as of 30th Apr 2025)</span> | 1.28 B      | 14,839 RPS              | **15.9 × slower**  |
| Estuary <br/><span className='text-xs text-slate-500'>(as of 30th Apr 2025)</span>            | 0.34 B      | 3,982 RPS               | **59.1 × slower**¹ |
| Airbyte Cloud <br/><span className='text-xs text-slate-500'>(as of 30th Apr 2025)</span>      | 12.7 M      | 457 RPS                 | **515.1 × slower** |
...
**Key takeaway:** OLake now delivers 5x faster bulk-load performance than Fivetran, while outpacing every other open-source alternative by 15x to over 500x.
...
| ------------- | --------------- | ------------------------------------------------------------------------------------: | -----------: |
| **OLake**     | Full Load / CDC | Cost of a `Standard D64ls v5 (64 vcpus, 128 GiB memory)` running for 4.7 hours < $ 15 | 4.01 B / 50M |
