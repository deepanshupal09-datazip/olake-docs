...
![Semi-structured data ingestion challenges with changing data types in MongoDB](/img/blog/cover/handling-changing-data-type-during-semi-structured-data-ingestion-cover.webp)
...
![MongoDB document with mixed data types showing schema evolution challenges](/img/blog/2024/10/handling-changing-data-type-1.webp)
...
* **Schema Enforcement (When Enabled)**:
    ...
    * ![MongoDB aggregation pipeline handling data type changes with $addFields stage](/img/blog/2024/10/handling-changing-data-type-2.webp)
...
![MongoDB Compass query result showing data type normalization for analytics](/img/blog/2024/10/handling-changing-data-type-3.webp)
...
![MongoDB aggregation pipeline with $convert for data type transformation](/img/blog/2024/10/handling-changing-data-type-4.webp)

And the table after first full sync:

![MongoDB Compass query result showing successful data type conversion with error handling](/img/blog/2024/10/handling-changing-data-type-5.webp)
...
![MongoDB aggregation pipeline with $switch for conditional data type handling](/img/blog/2024/10/handling-changing-data-type-6.webp)
...
![MongoDB Compass query result showing conditional data type processing with fallback values](/img/blog/2024/10/handling-changing-data-type-7.webp)
...
![MongoDB aggregation pipeline with $ifNull for handling missing data type values](/img/blog/2024/10/handling-changing-data-type-8.webp)
...
![MongoDB Compass query result showing null value handling for data type consistency](/img/blog/2024/10/handling-changing-data-type-9.webp)
...
![MongoDB aggregation pipeline with $type for data type detection and validation](/img/blog/2024/10/handling-changing-data-type-10.webp)

Hevo showing error when the `INT` column started to receive string data OR an array of objects with auto-mapping enabled.

![MongoDB Compass query result showing data type validation with error handling](/img/blog/2024/10/handling-changing-data-type-11.webp)
...
![MongoDB aggregation pipeline with $cond for conditional data type processing](/img/blog/2024/10/handling-changing-data-type-12.webp)
...
![MongoDB Compass query result showing conditional data type handling with fallback logic](/img/blog/2024/10/handling-changing-data-type-13.webp)
...
![MongoDB aggregation pipeline with $merge for data type consolidation](/img/blog/2024/10/handling-changing-data-type-14.webp)
