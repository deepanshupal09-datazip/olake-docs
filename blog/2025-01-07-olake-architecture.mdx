...
![OLake CDC platform architecture with source destination and sync components](/img/blog/cover/olake-architecture-cover.webp)
...
![OLake component diagram showing discovery sync and write phases for CDC pipeline](/img/blog/2025/01/olake-architecture-1.webp)
