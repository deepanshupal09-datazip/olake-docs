...
![OLake jobs UI with Create Job button for setting up CDC replication](/img/docs/getting-started/create-your-first-job/job-create.webp)
...
![OLake source connector selection UI showing Postgres connector with version dropdown](/img/docs/getting-started/create-your-first-job/job-source-connector.webp)

![OLake Postgres source configuration UI entering host, port, database, username, password](/img/docs/getting-started/create-your-first-job/job-source-config.webp)
...
![OLake destination connector UI choosing Apache Iceberg with catalog options](/img/docs/getting-started/create-your-first-job/job-dest-connector.webp)

![Selecting AWS Glue catalog for Apache Iceberg destination in OLake UI](/img/docs/getting-started/create-your-first-job/job-dest-catalog.webp)

Provide the connection details and **Test Connection**.

![OLake Iceberg destination config UI entering AWS region, credentials, database name](/img/docs/getting-started/create-your-first-job/job-dest-config.webp)
...
![OLake streams UI selecting tables to replicate with sync mode and normalization options](/img/docs/getting-started/create-your-first-job/job-streams.webp)
...
![OLake stream select UI showing fivehundred table selected for CDC replication](/img/docs/getting-started/create-your-first-job/job-stream-select.webp)
...
![OLake partitioning UI configuring dropoff_datetime column partition by year](/img/docs/getting-started/create-your-first-job/job-stream-partition.webp)

Add the **Data Filter** so we only move rows from 2010 onward.

![OLake data filter UI entering SQL filter condition for timestamp column](/img/docs/getting-started/create-your-first-job/job-data-filter.webp)
...
![OLake job schedule UI setting job name and daily 12 AM replication frequency](/img/docs/getting-started/create-your-first-job/job-schedule.webp)

You're set! 🎉

![OLake job creation success message with green checkmark and job details](/img/docs/getting-started/create-your-first-job/job-creation-success.webp)

Want results right away? Start a run immediately with **Jobs → (⋮) → Sync Now**.

![OLake jobs UI with three-dot menu for triggering immediate sync job run](/img/docs/getting-started/create-your-first-job/job-sync-now.webp)

You'll see status badges on the right (**Running / Failed / Completed**).  
For more details, open **Job Logs & History**.

- Running  
  ![OLake jobs UI showing running job status with blue spinner icon](/img/docs/getting-started/create-your-first-job/job-running.webp)

- Completed  
  ![OLake jobs UI showing completed sync status with green check mark](/img/docs/getting-started/create-your-first-job/job-success.webp)

Finally, verify that data landed in S3/Iceberg as configured:

![Amazon S3 bucket UI showing Iceberg table folders with Parquet data files](/img/docs/getting-started/create-your-first-job/job-data-s3.webp)
...
![OLake edit streams UI with source and destination stepper for modifying job config](/img/docs/getting-started/create-your-first-job/job-edit-streams-page.webp)

> By default, source/destination editing is locked. Click **Edit** to unlock.

![OLake edit destination UI with Edit button to unlock destination configuration](/img/docs/getting-started/create-your-first-job/job-edit-destination.webp)
...
![OLake jobs UI showing Resume button for reactivating paused replication job](/img/docs/getting-started/create-your-first-job/job-resume.webp)

**Job Logs & History** — See all runs. Use **View Logs** for per-run details.

![OLake job history UI with View Logs button for accessing sync run details](/img/docs/getting-started/create-your-first-job/view-logs.webp)

![OLake logs page showing detailed sync execution logs with timestamp and status](/img/docs/getting-started/create-your-first-job/logs-page.webp)
...
![OLake job settings UI for renaming, changing frequency, pausing, or deleting job](/img/docs/getting-started/create-your-first-job/job-settings.webp)
...
*Start logs*
![Terminal output showing Docker OLake discover command starting stream discovery](/img/docs/getting-started/create-your-first-job/cli-discover-logs-start.webp)

*Completion*
![Terminal output showing Docker OLake discover command completed with streams.json](/img/docs/getting-started/create-your-first-job/cli-discover-logs-end.webp)
...
*Sync start*
![Terminal output showing Docker OLake sync command beginning data replication](/img/docs/getting-started/create-your-first-job/cli-sync-logs-start.webp)

*Sync completed*
![Terminal output showing Docker OLake sync command completed with stats.json](/img/docs/getting-started/create-your-first-job/cli-sync-logs-end.webp)
...
![Amazon S3 bucket UI showing Iceberg CLI generated table folders with data files](/img/docs/getting-started/create-your-first-job/cli-s3-data.webp)
