...
![OLake CDC orchestration with Apache Airflow DAG scheduling architecture](/img/blog/cover/olake-airflow-cover.webp)
...
![Airflow web UI showing OLake DAG tasks with sync configuration and logs](/img/blog/2025/04/olake-airflow-1.webp)
...
![Airflow Connections UI adding OLake source and destination configuration parameters](/img/blog/2025/04/olake-airflow-2.webp)
