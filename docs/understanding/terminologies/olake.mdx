...
![For dynamic](/img/docs/terminologies/dynamic.webp)
...
![For custom](/img/docs/terminologies/custom.webp)
...
![For complete_1](/img/docs/terminologies/complete_1.webp)

![For complete_2](/img/docs/terminologies/complete_1.webp)