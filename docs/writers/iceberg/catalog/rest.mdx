  ...
  <Tabs queryString="tab">
    <TabItem value="rest-ui" label="OLake UI" default>
      ...
      <div className='flex justify-center w-2/3 mx-auto'>
        ![REST catalog setup form with required fields for catalog type, URIs, database, S3 path, AWS credentials, and region.](/img/docs/iceberg/catalog/rest/rest-generic-config.webp)
      </div>
      ...
      **Permissions**:
      ...
      <Tabs queryString="tab">
        <TabItem value="rest-ui" label="OLake UI" default>
          ...
          <div className='flex justify-center w-2/3 mx-auto'>
          ![REST catalog configuration form for Iceberg with fields for REST URI, S3 path, Iceberg DB, AWS keys, and region](/img/docs/iceberg/catalog/rest/rest-nessie-config.webp)
        </div>
...
<Tabs queryString="tab">
  ...
  <TabItem value="s3tables-ui" label="OLake UI" default>
      ...
      <div className='flex justify-center w-2/3 mx-auto'>
        ![Iceberg REST config form with required fields for Catalog URI, S3 Path, database, AWS credentials, and region](/img/docs/iceberg/catalog/rest/rest-s3tables-config.webp)
      </div>
  ...
  <TabItem value="unity" label="Unity">
      ...
      4. Turn on **Personal Access Tokens** if it's not already enabled
        ...
        ![Settings page with "Personal Access Tokens" toggle enabled for API access](/img/docs/iceberg/catalog/unity/unity-catalog-personal-access-tokens.webp)
      ...
      1. Create a new external location as Unity Catalog Iceberg requires S3-based external storage (when using AWS).
        ...
        ![Catalog menu with options highlighted for creating an external location, credential, or connection.](/img/docs/iceberg/catalog/unity/unity-catalog-grant-permissions.webp)
      ...
      1. Create a new schema using the storage location created in Step 2
        ...
        ![Form to create a new schema, including schema name and selection of an external storage location.](/img/docs/iceberg/catalog/unity/unity-catalog-create-external-location.webp)
      ...
      3. Grant the following permissions to the newly created user:
        ...
        ![Grant dialog showing user-level privilege settings for a Databricks schema, with all privileges, external use, and manage rights enabled](/img/docs/iceberg/catalog/unity/unity-catalog-create-schema.webp)
    ...
    **Required permissions**:
    ...
    <Tabs queryString="tab">
      ...
      Before setting up the destination, ensure the [source](/docs/getting-started/creating-first-pipeline#2-configure-source) has been successfully configured.   
        ...
        <div className='flex justify-center w-2/3 mx-auto'>
          ![REST endpoint config form with fields for REST, database, S3, and AWS credentials](/img/docs/iceberg/catalog/rest/rest-polaris-config.webp)
        </div>
...
```
    ...
    **S3 Access Policy:**
    ...
    :::info
     When setting up **OLake**, ensure OLake runs on an instance with AWS roles and policies similar to those used for **Polaris**.
    :::
