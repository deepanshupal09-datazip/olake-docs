...
![OLake data replication on Kubernetes architecture with Helm deployment diagram](/img/blog/cover/olake-on-kubernetes.webp)
...
![OLake Kubernetes architecture data flow with UI worker Temporal PostgreSQL](/img/blog/2025/10/dataflow.webp)
...
![OLake UI running on Kubernetes showing jobs dashboard and sync status](/img/blog/2025/10/olakeuik8s.webp)
