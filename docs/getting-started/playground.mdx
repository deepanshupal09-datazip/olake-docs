...
### 5. Interacting with Olake
      ...
      2. Create and Configure a Job: Create a Job to define and run the data pipeline:
        ...
        #### Set up the Source:
              ...
              * **Password**: password 
              ...
              ![olake-presto](/img/docs/playground/olake-iceberg-presto-1.webp)
        ...
        #### Set up the Destination:
             ...
             * **S3 Secret Key**: minio123 
             ...
             ![olake-presto](/img/docs/playground/olake-iceberg-presto-2.webp)
  ...
  ### 6. Query in Presto 
     ...
     ```
     ![olake-presto](/img/docs/playground/prestoweb.webp)
    ...
    SELECT * FROM iceberg.weather.weather LIMIT 10; 
     ![olake-presto](/img/docs/playground/presto_query.webp)
