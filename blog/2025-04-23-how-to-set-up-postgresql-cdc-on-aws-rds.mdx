...
![AWS RDS PostgreSQL parameter group configuration for enabling logical replication](/img/blog/2025/04/how-to-set-up-postgresql-cdc-on-aws-rds-1.webp)
...
![PostgreSQL replication slot creation command output showing slot creation success](/img/blog/2025/04/how-to-set-up-postgresql-cdc-on-aws-rds-2.webp)
...
![OLake UI source configuration screen for PostgreSQL CDC with replication slot](/img/blog/2025/04/how-to-set-up-postgresql-cdc-on-aws-rds-5.webp)
...
![OLake sync job running successfully showing CDC replication progress and status](/img/blog/2025/04/how-to-set-up-postgresql-cdc-on-aws-rds-4.webp)
