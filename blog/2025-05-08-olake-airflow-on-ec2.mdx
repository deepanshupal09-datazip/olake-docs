...
![OLake CDC pipeline orchestration with Apache Airflow on AWS EC2 architecture](/img/blog/cover/olake-airflow-on-ec2-cover.webp)
...
![Airflow DAG UI showing OLake sync tasks with schedule and success status](/img/blog/2025/05/olake-airflow-on-ec2-1.webp)
...
![AWS EC2 console showing OLake Airflow instance configuration and running state](/img/blog/2025/05/olake-airflow-on-ec2-2.webp)
...
![Amazon Athena query editor displaying OLake synced Iceberg table data results](/img/blog/2025/05/olake-airflow-on-ec2-3.webp)
