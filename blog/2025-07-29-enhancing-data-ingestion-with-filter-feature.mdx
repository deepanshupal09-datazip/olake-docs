...
![OLake data ingestion pipeline with SQL-style filter optimization architecture](/img/blog/cover/filter-ingestion-cover.webp)
...
![Data ingestion pipeline flow diagram showing source filter and destination stages](/img/blog/2025/09/data-ingestion-pipeline.webp)
...
![Regular expression pattern diagram for parsing SQL-style filter conditions](/img/blog/2025/09/regex-pattern.webp)
...
![SQL to MongoDB BSON filter translation diagram for query optimization](/img/blog/2025/09/sql-mongodb-BSON.webp)
