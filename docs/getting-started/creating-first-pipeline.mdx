...
<div className='mx-auto w-full lg:w-[80%]'>
  ![OLake inactive jobs list with menu showing resume job option for Postgres Iceberg pipeline](../../static/img/docs/getting-started/create-your-first-job/job-resume.webp)
</div>
...
<div className='mx-auto w-full lg:w-[80%]'>
  ![OLake Postgres Iceberg job logs history screen showing completed run and view logs action](../../static/img/docs/getting-started/create-your-first-job/view-logs.webp)
</div>

Once you click **View Logs**, you'll see the logs for the selected job run.

<div className='mx-auto w-full lg:w-[80%]'>
  ![OLake job logs screen displaying detailed execution logs for Postgres to Iceberg sync job](../../static/img/docs/getting-started/create-your-first-job/logs-page.webp)
</div>
...
<div className='mx-auto w-full lg:w-[80%]'>
  ![OLake job settings screen showing scheduling, pause and delete options for Postgres Iceberg job](../../static/img/docs/getting-started/create-your-first-job/job-settings.webp)
</div>
