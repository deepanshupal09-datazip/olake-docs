...
![OLake create job UI selecting existing Postgres data source for pipeline setup](/img/blog/2025/13/step-5-1.webp)

![OLake stream selection step with Full Refresh + CDC sync for dz-stag-users table](/img/blog/2025/13/step-5-2.webp)
...
![Amazon Athena editor querying olake_test_table with SQL SELECT and results](/img/blog/2025/13/step-7.webp)
