...
description: Setup MySQL via Docker Compose with OLake UI
sidebar_position: 3
---
...
:::info
Now that you have configured the local database, you can either follow the [getting-started guide](../../../getting-started/mysql#step-2-generate-a-streams-file) to start syncing data or review the broader [MySQL connector overview](/docs/connectors/mysql/overview) to understand the complete ELT flow with OLake.
:::
